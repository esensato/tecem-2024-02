...
function invokeSTT(blob) {
  ...
  myHeaders.append(
    "Authorization",
    "Basic XxVTtRMnKF5aV3CxGPWlz6lnqsNLDzC8iD8qMjb4l8mU"
  );
  ...
  const baseUrl = new URL(
    "https://api.us-south.speech-to-text.watson.cloud.ibm.com/instances/82a7d689-98aa-4227-a9e5-48600e9472cb/v1/recognize?model=en-US_Multimedia&background_audio_suppression=0.3"
  );
